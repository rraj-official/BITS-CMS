...
const Staff_new_complaints = () => {
    ...
    const submitComplaint = async (complaintData) => {
        try {
            ...
            const response = await axios.post(`http://localhost:5000/api/staff/complaints/${loginData.email}`, complaintData, { withCredentials: true });
            console.log("Complaint Data sent successfully ");
            console.table(complaintData);
            navigate('/staff_past_complaints')
        }
        catch {
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    value={complaintData.User_department}
                                    className="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 border-none outline-none sm:text-sm sm:leading-6"
                                    onChange={(e) => {
                                        setComplaintData(prevState => ({
                                            ...prevState,
...
export default Staff_new_complaints