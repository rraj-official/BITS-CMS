...
const StaffComplaints = () => {
    ...
    const fetchComplaints = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/staff/complaints/');
    ...
    const updateComplaints = async (updatedComplaints) => {
        try {
            const response = await axios.post(`http://localhost:5000/api/staff/complaints/update`, updatedComplaints, { withCredentials: true });
