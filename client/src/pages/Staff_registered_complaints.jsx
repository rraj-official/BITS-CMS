...
const Staff_registered_complaints = () => {
    ...
    useEffect(() => {
        const fetchComplaints = async () => {
            try {
                if (loginData.email) {
                    const response = await axios.get(`http://localhost:5000/api/staff/complaints/${loginData.email}`);
...
export default Staff_registered_complaints