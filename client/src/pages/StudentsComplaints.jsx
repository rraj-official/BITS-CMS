                        ...
                        {sampleComplaints.filter((user)=>user.status==selectedComplaintType||selectedComplaintType=='All').map((user) => (
                            <>
                                ...
                                <th
                                    className="px-6 py-4">
                                    {user.id}
                                </th><td className="px-6 py-4">{user.name} </td><td className="px-6 py-4">{user.category} </td><td className="px-6 py-4">{user.subcategory}</td><td className="px-6 py-4"><StatusDropDown currentStatus={user.status} /></td><td className="px-6 py-4 max-w-md overflow-hidden break-words text-ellipsis">{user.description}</td><td className="px-6 py-4">{user.date}</td><td className="px-6 py-4"><button className='font-medium hover:font-semibold'>View images</button></td><td className="px-6 py-4"><DropDown /></td><td className="px-6 py-4">{user.remarks}</td>
